...
# 1й вариант:
# path = 'C:\Users\Geniy\Desktop\в ноут\D_ОБУЧЕНИЕ_GEEK_BRAINS\1_УЧЕБНЫЕ_МАТЕРИАЛЫ\007_Знакомство_с_языком_Python\Python_лекции_семинары_дом_задания\Python_tasks\lecture03.txt'
path = '1 2 3 5 8 15 23 38'
data = path # добавила, ч.б.проверить остальной код
